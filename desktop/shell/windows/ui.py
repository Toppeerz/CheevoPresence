"""Tk-based settings window for the Windows desktop shell."""
...
class SettingsWindow:
    """Render the Tk settings window and drive connect and disconnect actions."""
    ...
    def _build_layout(self):
        ...
        self.main = tk.Frame(self.root, bg=self.BG, padx=20, pady=16)
    ...
    def _refresh_update_notice(self):
        ...
        if update_status.available:
            ...
            self.update_label.configure(text=" Update available", cursor="hand2")
